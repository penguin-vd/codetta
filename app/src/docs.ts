...
export const DOCS: DocEntry[] = [
  ...
  },
  {
    ...
    title: "positioning",
    kind: "Primitive",
    summary: "Pins an element to an exact bar and beat.",
    syntax: "@<bar>.<beat> <element>",
    example: "@1.1 C3.whole",
    body: [
      "By default elements follow one another in time. A position pins the next element to an absolute bar and beat instead.",
      "Bars and beats are read in the current time signature. Dynamics use the same @ positions.",
    ],
    aliases: ["positioned", "at"],
    see: ["time_signature", "dynamic"],
  },
  {
    slug: "repeat",
    title: "repeat",
