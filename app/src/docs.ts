...
export const DOCS: DocEntry[] = [
    ...
    },
    {
        ...
        syntax: '.[N]<whole | half | quarter | eighth | sixteenth>[.dot][.t]',
        example: 'C4.quarter   rest.half   Cmaj.whole   E4.quarter.dot   C4.2whole   C4.quarter.t',
        body: [
            ...
            'Add .t for a triplet — the note lasts 2/3 of its written value. Three triplet quarters fit in the space of two regular quarters.',
            'Prefix with a number to multiply: .2whole spans two bars, .3half spans one and a half bars.',
            'Modifiers compose: C4.quarter.dot.t is a dotted triplet quarter.',
        ],
        aliases: ['durations', 'whole', 'half', 'quarter', 'eighth', 'sixteenth', 'dot', 'dotted', 't', 'triplet', 'triplets'],
        see: ['note', 'rest'],
    },
    {
        slug: 'rest',
        ...
        body: [
            'A rest advances time without sounding a note. It takes the same durations as notes.',
        ],
        see: ['duration', 'note'],
    },
    {
    ...
    },
    {
        ...
        body: [
            'Multiplies the target in place. Used in songs (verse * 2), on tracks, and within sequences.',
        ],
        see: ['song', 'section'],
    },
    {
    ...
    },
    {
        ...
        body: [
            'Multiplies every duration, slowing the line down — augment x2 makes it twice as long.',
        ],
