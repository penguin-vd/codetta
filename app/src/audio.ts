...
export const INSTRUMENTS: Instrument[] = [
    {
        ...
        make: () =>
            new Tone.PolySynth(Tone.Synth, {
                ...
                envelope: { attack: 0.006, decay: 0.2, sustain: 0.5, release: 0.4 },
            }),
    },
    {
        id: 'reed',
    ...
    },
    {
        ...
        make: () =>
            new Tone.PolySynth(Tone.Synth, {
                ...
                envelope: { attack: 0.002, decay: 0.1, sustain: 0.35, release: 0.2 },
            }),
    },
    {
        id: 'glass',
    ...
    },
    {
        ...
        make: () =>
            new Tone.PolySynth(Tone.AMSynth, {
                harmonicity: 2,
                envelope: { attack: 0.4, decay: 0.3, sustain: 0.8, release: 1.6 },
            }),
    },
    {
        id: 'pluck',
